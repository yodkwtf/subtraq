  ...
  return (
    <DialogPortal>
      ...
      >
        ...
        <DialogPrimitive.Close className='absolute right-4 top-4 rounded-md p-1 opacity-70 transition-opacity hover:opacity-100 focus-ring disabled:pointer-events-none'>
          <X className='h-4 w-4' />
